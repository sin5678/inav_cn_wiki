...
|  imu_dcm_kp  | 2500 | Inertial Measurement Unit KP Gain |
|  imu_dcm_ki  | 50 | Inertial Measurement Unit KI Gain |
...
|  servo_lowpass_freq  | 400 | Selects the servo PWM output cutoff frequency. Valid values range from 10 to 400. This is a fraction of the loop frequency in 1/1000ths. For example, 40 means 0.040. The cutoff frequency can be determined by the following formula: Frequency = 1000 * servo_lowpass_freq / looptime |
