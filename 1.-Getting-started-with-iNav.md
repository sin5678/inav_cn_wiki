...
* iNav won't arm? iNav has extra safety feature that prevents you from arming your aircraft if certian condition are meet, or not meet. This is controlled by cli variable "Nav_extra_arming_safety" which is default turned on
     1.No valid GPS lock.
