...
| `mag_hardware`                     | If you want to replace the onboard compass with a device of the same type (same I2C address), you need to physically disable the onboard device. In all cases, you can use a MAG_GPS, i.e. the serial compasses in the so called "NAZA" GPS/compass units. These have only a serial connection rather than serial and I2C. 
 0: Default, 1: Disable MAG, 2: HMC5883, 3: AK8975, 4: MAG_GPS, 5: MAG3110, 6: AK8963| 0 | 6 |
