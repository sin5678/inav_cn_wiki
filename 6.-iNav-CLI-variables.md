...
| `nav_use_midthr_for_althold`       | If set to OFF, the FC remembers your throttle stick position when enabling ALTHOLD and treats it as a throttle midpoint | OFF | ON |
