...
| `nav_manual_climb_rate`            | Maximum climb/descent rate firmware is allowed when processing pilot input for ALTHOLD control mode | 10 | 2000 |
| `pos_hold_deadband`            | | 10 | 250 |
| `alt_hold_deadband`            | Defines the deadband of throttle during alt_hold | 10 | 250 |
...
| `nav_land_slowdown_minalt`         | Defines at what altitude the descent velocity should start to be 25% of `nav_landing_speed` |50 | 1000 |
