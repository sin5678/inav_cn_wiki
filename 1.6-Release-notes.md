...
Misconfigured or malfunctioning compass can confuses the firmware in such way that it wont't realise where North direction is. This may cause the machine to fly in wrong direction when i.e. doing an RTH and fly away instead of returning to home.
