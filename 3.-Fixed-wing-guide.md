...
* Disable barometer (set baro_hardware = 1) on Naze32 targets due to critical bug that can make airplane dive to ground. Issue [543](https://github.com/iNavFlight/inav/pull/543)
