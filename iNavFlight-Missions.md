...
The initial implementation proposed for iNav is supported by ezgui, mwp and QGroundControl. Probably some of the Android apks for Mavlink (DroidPlanne, Tower) will work with this telemetry protocol. 
