...
- When enabling the navigation modes in the modes tab, they don´t light up green until you have a valid 3D GPS fix, is armed and everything is calibrated properly.  
- INAV activates its specific modes only when armed.  
- Flightmodes like poshold, althold, RTH are self contained and don't need any additional modes like angle mode activated.
