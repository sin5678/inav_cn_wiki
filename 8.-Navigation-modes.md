...
This flight mode is intended to provide assistance for launching the fixed-wing UAVs. Launch detection works by looking at airplane forward acceleration. Sequence for launching airplane using LAUNCH mode looks like this:
