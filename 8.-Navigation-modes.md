...
- Flightmodes are self contained. Example with RTH and WP (Waypoints) it's not neccesary to enable angle, althold or mag, it enables what it needs. Keep in mind that POSHOLD is also self contained and enables what it need, but that does not include ALTHOLD. Read more below in POSHOLD section.  
...
**Be aware that launching a flyingwing by slinging it by the wing tip is not yet supported. Only regular handlaunch and bungee launch.**
